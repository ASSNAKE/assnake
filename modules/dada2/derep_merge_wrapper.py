...
shell('''export LANG=en_US.UTF-8;\nexport LC_ALL=en_US.UTF-8;\n
                    Rscript  {derep_dada_merge_script} '{snakemake.input.r1}' '{snakemake.input.r2}' '{snakemake.input.errF}' '{snakemake.input.errR}' '{snakemake.output.merged}' {params_str} >{snakemake.log} 2>&1''')
