        ...
        if instance_config is not None:
            ...
            for preset_file_loc in presets_included_files:
                ...
                preset_crc32_hex = compute_crc32_of_dumped_dict(
                    preset_file_loc, self.preset_file_format)
            ...
            if os.path.isdir(os.path.join(self.included_presets_dir, self.static_files_dir_name)):
    ...
    def find_preset_by_name(self, preset_name):
        ...
        if instance_config is not None:
            ...
            preset_dicts = [ {
                ...
                'preset_hash': p.split('.')[1] if len(p.split('.')) > 1 else None,
                'full_name': p 
                } for p in presets ]
